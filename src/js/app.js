...
const app = {
  ...
  activatePage: function (pageId) {
    ...
    /*add class "active" to matching pages, remove from non-machting */
    for (let page of thisApp.pages) {
      page.classList.toggle(classNames.pages.active, page.id == pageId);
    }

    /*add class "active" to matching links, remove from non-machting */
    for (let link of thisApp.navLinks) {
  ...
  initHome: function () {
    const thisApp = this;
    const widgetHome = document.querySelector(select.containerOf.home);
    thisApp.booking = new Home(widgetHome);
  }
};
